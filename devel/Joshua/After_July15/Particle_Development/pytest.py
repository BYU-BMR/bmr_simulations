...
class DatafileGenerator():
    ...
    x0 = 0.0
    x1 = scale*20.0*cbd_dia
    y0 = 0.0
    y1 = scale*10.0*cbd_dia
    z0 = 0.0
    z1 = scale*10.0*cbd_dia
    ...
    def setUpSimulation(self):
        ...
        self.placeparticlesclosely(xlen,ylen,zlen,self.cbd_dia,self.cbd_type)
