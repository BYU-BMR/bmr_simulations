...
class DatafileGenerator():
   ...
   # data string containing molecule ID, type, dia, rho, x, y, z, 0 0 0 
    ...
    x0 = 0.0
    x1 = scale*3*100.0*dia
    y0 = 0.0
    y1 = scale*1*40.0*dia
    z0 = 0
    z1 = scale*4*100.0*dia
    ...
    def setUpSimulation(self):
        ...
        vertex4 = (xf,zlen*0.05/4+opening_width)
        ...
        vertex8 = (xi,zlen*0.05/4+opening_width)
    ...
    def fillCubeWithRandomMix(self,x,y,z,x2,y2,z2):
        ...
        for yi in np.arange(yl+self.dia*3,yh-self.dia,self.dia*5):
            for zi in np.arange(zl+self.dia*5,zh-self.dia*7,self.dia*5):
                for xi in np.arange(xl+self.dia*3,xh-self.dia*2,self.dia*5):
