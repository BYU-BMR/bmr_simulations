...
int main()
{
	...
	output_file << fixed << "dump_modify  2   acolor 1 olivedrab  acolor 2 midnightblue acolor 3 midnightblue acolor 4 midnightblue acolor 5 midnightblue acolor 6 midnightblue acolor 7 midnightblue acolor 8 midnightblue acolor 9 midnightblue acolor 10 olivedrab  acolor 11 olivedrab " << endl;
	output_file << fixed << endl;
	output_file << fixed << "#-------------------------------------------------------------------------------]" << endl;
	output_file << fixed << endl;
	output_file << fixed << endl;
	...
	output_file1 << fixed << "dump_modify  2   acolor 1 olivedrab  acolor 2 midnightblue acolor 3 midnightblue acolor 4 midnightblue acolor 5 midnightblue acolor 6 midnightblue acolor 7 midnightblue acolor 8 midnightblue acolor 9 midnightblue acolor 10 olivedrab  acolor 11 olivedrab " << endl;
	output_file1 << fixed << endl;
	output_file1 << fixed << "#-------------------------------------------------------------------------------]" << endl;
	output_file1 << fixed << endl;
	output_file1 << fixed << endl;
	...
	output_batch_file << fixed << endl;
	output_batch_file << fixed << endl;
	output_batch_file << fixed << "#SBATCH --nodes=1 --ntasks=12" << endl;
	...
	output_batch_file << fixed << endl;
	output_batch_file << fixed << endl;
	output_batch_file << fixed << "cp restart.viscosity_elasticity_calculation .." << endl;
	output_batch_file << fixed << "cd .." << endl;
	
	output_batch_file << fixed << "foldername3=solid" << endl;
	output_batch_file << fixed << "cp restart.viscosity_elasticity_calculation $foldername3" << endl;
//	output_batch_file << fixed << "cp lj_potential.txt $foldername3" << endl;
	output_batch_file << fixed << "cp diameter_Active.txt $foldername3" << endl;
	output_batch_file << fixed << "cd $foldername3" << endl;
	output_batch_file << fixed << "sbatch parallel_solid.sh" << endl;
