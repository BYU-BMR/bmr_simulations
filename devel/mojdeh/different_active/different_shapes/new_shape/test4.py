...
class DatafileGenerator():
    ...
    def setUpSimulation(self):
        ...
        opening_width = zlen*0.15
        side_thickness = xlen*0.04
        xi = xlen*0.04
        xf = xi + side_thickness
        vertex1 = (xi,zlen*0.95)
        vertex2 = (xi,zlen*0.45)
        vertex3 = (xf,zlen*0.25)
        vertex4 = (xf,zlen*0.05+opening_width)
        
        xi = xf + opening_width
        xf = xi + side_thickness
        vertex5 = (xf,zlen*0.95)
        vertex6 = (xf,zlen*0.45)
        vertex7 = (xi,zlen*0.25)
        vertex8 = (xi,zlen*0.05+opening_width)
    ...
    def fillCubeWithMix(self,x,y,z,x2,y2,z2):
        ...
        y_act_range = math.floor((yh-yl)/spacing)
        z_act_range = math.floor((zh-zl)/spacing)
