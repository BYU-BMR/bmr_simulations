...
#SBATCH --mem-per-cpu=2G -t120:00:00 
...
#	cp number.txt $foldername
	...
	cp sbatch_and_potential_creator_active_liquid.cpp $foldername
	cd $foldername

	
		icpc -O3 -std=c++11 sbatch_and_potential_creator_active_liquid.cpp -o create_sbatch_and_potential
