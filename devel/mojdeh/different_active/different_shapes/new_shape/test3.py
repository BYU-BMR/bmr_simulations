...
class DatafileGenerator():
    ...
    def setUpSimulation(self):
        ...
        thickness = zlen*0.15
        x = xlen*0.04
        vertex1 = (x+xlen*0.00,zlen*0.95)
        vertex2 = (x+xlen*0.00,zlen*0.45)
        vertex3 = (x+xlen*0.04,zlen*0.25)
        vertex4 = (x+xlen*0.04,zlen*0.05+thickness)
        
        x = xlen*0.08 + thickness
        vertex5 = (x+xlen*0.04,zlen*0.95)
        vertex6 = (x+xlen*0.04,zlen*0.45)
        vertex7 = (x+xlen*0.00,zlen*0.25)
        vertex8 = (x+xlen*0.00,zlen*0.05+thickness)

        vertex9 = (0,zlen*0.05)
        vertex10 = (xlen,zlen*0.05)
        ...
        #fill in the box with the active particles
        '''radius = 4
        spacing = 3*radius
        xl,xh = vertex1[0],vertex5[0]
        yl,yh = self.y0,self.y1
        zl,zh = vertex2[1],vertex1[1]
        ...
        self.drawSphere(50,50,100,5)

        self.drawSphere(52,50,105,2)

        self.drawSphere(48,50,95,2)
