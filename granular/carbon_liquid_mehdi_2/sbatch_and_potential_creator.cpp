...
int main()
{
	...
	output_file << fixed << endl;
	output_file << fixed << "pair_coeff	1 1	lj/sf " << u[9] << " " << u[10] << " " << u[11] << endl;
	output_file << fixed << "pair_coeff	2 2 lj/sf	1.38E-05	0.694	2.779" << endl;
	output_file << fixed << "pair_coeff	3 3 lj/sf	1.66E-05	2.046	4.297" << endl;
	output_file << fixed << "pair_coeff	4 4	lj/sf	3.08E-05	3.948	6.432" << endl;
	output_file << fixed << "pair_coeff	5 5	lj/sf	6.42E-05	5.709	8.408" << endl;
	output_file << fixed << "pair_coeff	6 6	lj/sf	1.41E-04	7.385	10.290" << endl;
	output_file << fixed << "pair_coeff	7 7	lj/sf	3.33E-04	9.024	12.129" << endl;
	output_file << fixed << "pair_coeff	8 8	lj/sf	7.72E-04	10.424	13.700" << endl;
	output_file << fixed << "pair_coeff	9 9	lj/sf	1.22E-02	13.640	17.311" << endl;
	output_file << fixed << "pair_coeff	1 2	lj/sf	3.68E-01	0.897	3.007" << endl;
	output_file << fixed << "pair_coeff	1 3	lj/sf	3.98E-01	1.573	3.766" << endl;
	output_file << fixed << "pair_coeff	1 4	lj/sf	4.98E-01	2.524	4.833" << endl;
	output_file << fixed << "pair_coeff	1 5	lj/sf	6.65E-01	3.405	5.821" << endl;
	output_file << fixed << "pair_coeff	1 6	lj/sf	9.13E-01	4.243	6.762" << endl;
	output_file << fixed << "pair_coeff	1 7	lj/sf	1.28E+00	5.062	7.682" << endl;
	output_file << fixed << "pair_coeff	1 8	lj/sf	1.74E+00	5.762	8.467" << endl;
	output_file << fixed << "pair_coeff	1 9	lj/sf	3.69E+00	7.370	10.273" << endl;
	output_file << fixed << "pair_coeff	2 3	lj/sf	1.46E-05	1.370	3.538" << endl;
	output_file << fixed << "pair_coeff	2 4	lj/sf	1.78E-05	2.321	4.605" << endl;
	output_file << fixed << "pair_coeff	2 5	lj/sf	2.34E-05	3.201	5.593" << endl;
	output_file << fixed << "pair_coeff	2 6	lj/sf	3.19E-05	4.040	6.534" << endl;
	output_file << fixed << "pair_coeff	2 7	lj/sf	4.45E-05	4.859	7.454" << endl;
	output_file << fixed << "pair_coeff	2 8	lj/sf	6.01E-05	5.559	8.239" << endl;
	output_file << fixed << "pair_coeff	2 9	lj/sf	1.27E-04	7.167	10.045" << endl;
	output_file << fixed << "pair_coeff	3 4	lj/sf	2.19E-05	2.997	5.364" << endl;
	output_file << fixed << "pair_coeff	3 5	lj/sf	3.00E-05	3.878	6.353" << endl;
	output_file << fixed << "pair_coeff	3 6	lj/sf	4.19E-05	4.716	7.293" << endl;
	output_file << fixed << "pair_coeff	3 7	lj/sf	5.95E-05	5.535	8.213" << endl;
	output_file << fixed << "pair_coeff	3 8	lj/sf	8.14E-05	6.235	8.998" << endl;
	output_file << fixed << "pair_coeff	3 9	lj/sf	1.77E-04	7.843	10.804" << endl;
	output_file << fixed << "pair_coeff	4 5	lj/sf	4.39E-05	4.829	7.420" << endl;
	output_file << fixed << "pair_coeff	4 6	lj/sf	6.30E-05	5.667	8.361" << endl;
	output_file << fixed << "pair_coeff	4 7	lj/sf	9.15E-05	6.486	9.280" << endl;
	output_file << fixed << "pair_coeff	4 8	lj/sf	1.28E-04	7.186	10.066" << endl;
	output_file << fixed << "pair_coeff	4 9	lj/sf	2.93E-04	8.794	11.871" << endl;
	output_file << fixed << "pair_coeff	5 6	lj/sf	9.41E-05	6.547	9.349" << endl;
	output_file << fixed << "pair_coeff	5 7	lj/sf	1.40E-04	7.366	10.269" << endl;
	output_file << fixed << "pair_coeff	5 8	lj/sf	1.99E-04	8.066	11.054" << endl;
	output_file << fixed << "pair_coeff	5 9	lj/sf	4.85E-04	9.675	12.859" << endl;
	output_file << fixed << "pair_coeff	6 7	lj/sf	2.14E-04	8.205	11.209" << endl;
	output_file << fixed << "pair_coeff	6 8	lj/sf	3.12E-04	8.904	11.995" << endl;
	output_file << fixed << "pair_coeff	6 9	lj/sf	8.18E-04	10.513	13.800" << endl;
	output_file << fixed << "pair_coeff	7 8	lj/sf	1.44E-03	9.724	12.914" << endl;
	output_file << fixed << "pair_coeff	7 9	lj/sf	1.44E-03	11.332	14.720" << endl;
	output_file << fixed << "pair_coeff	8 9	lj/sf	2.48E-03	12.032	15.505" << endl;
	output_file << fixed << endl;
	output_file << fixed << endl;
	...
	output_file1 << fixed << endl;
	output_file1 << fixed << "pair_coeff	1 1	lj/sf " << u[9] << " " << u[10] << " " << u[11] << endl;
	output_file1 << fixed << "pair_coeff	2 2 lj/sf	1.38E-05	0.694	2.779" << endl;
	output_file1 << fixed << "pair_coeff	3 3 lj/sf	1.66E-05	2.046	4.297" << endl;
	output_file1 << fixed << "pair_coeff	4 4	lj/sf	3.08E-05	3.948	6.432" << endl;
	output_file1 << fixed << "pair_coeff	5 5	lj/sf	6.42E-05	5.709	8.408" << endl;
	output_file1 << fixed << "pair_coeff	6 6	lj/sf	1.41E-04	7.385	10.290" << endl;
	output_file1 << fixed << "pair_coeff	7 7	lj/sf	3.33E-04	9.024	12.129" << endl;
	output_file1 << fixed << "pair_coeff	8 8	lj/sf	7.72E-04	10.424	13.700" << endl;
	output_file1 << fixed << "pair_coeff	9 9	lj/sf	1.22E-02	13.640	17.311" << endl;
	output_file1 << fixed << "pair_coeff	1 2	lj/sf	3.68E-01	0.897	3.007" << endl;
	output_file1 << fixed << "pair_coeff	1 3	lj/sf	3.98E-01	1.573	3.766" << endl;
	output_file1 << fixed << "pair_coeff	1 4	lj/sf	4.98E-01	2.524	4.833" << endl;
	output_file1 << fixed << "pair_coeff	1 5	lj/sf	6.65E-01	3.405	5.821" << endl;
	output_file1 << fixed << "pair_coeff	1 6	lj/sf	9.13E-01	4.243	6.762" << endl;
	output_file1 << fixed << "pair_coeff	1 7	lj/sf	1.28E+00	5.062	7.682" << endl;
	output_file1 << fixed << "pair_coeff	1 8	lj/sf	1.74E+00	5.762	8.467" << endl;
	output_file1 << fixed << "pair_coeff	1 9	lj/sf	3.69E+00	7.370	10.273" << endl;
	output_file1 << fixed << "pair_coeff	2 3	lj/sf	1.46E-05	1.370	3.538" << endl;
	output_file1 << fixed << "pair_coeff	2 4	lj/sf	1.78E-05	2.321	4.605" << endl;
	output_file1 << fixed << "pair_coeff	2 5	lj/sf	2.34E-05	3.201	5.593" << endl;
	output_file1 << fixed << "pair_coeff	2 6	lj/sf	3.19E-05	4.040	6.534" << endl;
	output_file1 << fixed << "pair_coeff	2 7	lj/sf	4.45E-05	4.859	7.454" << endl;
	output_file1 << fixed << "pair_coeff	2 8	lj/sf	6.01E-05	5.559	8.239" << endl;
	output_file1 << fixed << "pair_coeff	2 9	lj/sf	1.27E-04	7.167	10.045" << endl;
	output_file1 << fixed << "pair_coeff	3 4	lj/sf	2.19E-05	2.997	5.364" << endl;
	output_file1 << fixed << "pair_coeff	3 5	lj/sf	3.00E-05	3.878	6.353" << endl;
	output_file1 << fixed << "pair_coeff	3 6	lj/sf	4.19E-05	4.716	7.293" << endl;
	output_file1 << fixed << "pair_coeff	3 7	lj/sf	5.95E-05	5.535	8.213" << endl;
	output_file1 << fixed << "pair_coeff	3 8	lj/sf	8.14E-05	6.235	8.998" << endl;
	output_file1 << fixed << "pair_coeff	3 9	lj/sf	1.77E-04	7.843	10.804" << endl;
	output_file1 << fixed << "pair_coeff	4 5	lj/sf	4.39E-05	4.829	7.420" << endl;
	output_file1 << fixed << "pair_coeff	4 6	lj/sf	6.30E-05	5.667	8.361" << endl;
	output_file1 << fixed << "pair_coeff	4 7	lj/sf	9.15E-05	6.486	9.280" << endl;
	output_file1 << fixed << "pair_coeff	4 8	lj/sf	1.28E-04	7.186	10.066" << endl;
	output_file1 << fixed << "pair_coeff	4 9	lj/sf	2.93E-04	8.794	11.871" << endl;
	output_file1 << fixed << "pair_coeff	5 6	lj/sf	9.41E-05	6.547	9.349" << endl;
	output_file1 << fixed << "pair_coeff	5 7	lj/sf	1.40E-04	7.366	10.269" << endl;
	output_file1 << fixed << "pair_coeff	5 8	lj/sf	1.99E-04	8.066	11.054" << endl;
	output_file1 << fixed << "pair_coeff	5 9	lj/sf	4.85E-04	9.675	12.859" << endl;
	output_file1 << fixed << "pair_coeff	6 7	lj/sf	2.14E-04	8.205	11.209" << endl;
	output_file1 << fixed << "pair_coeff	6 8	lj/sf	3.12E-04	8.904	11.995" << endl;
	output_file1 << fixed << "pair_coeff	6 9	lj/sf	8.18E-04	10.513	13.800" << endl;
	output_file1 << fixed << "pair_coeff	7 8	lj/sf	1.44E-03	9.724	12.914" << endl;
	output_file1 << fixed << "pair_coeff	7 9	lj/sf	1.44E-03	11.332	14.720" << endl;
	output_file1 << fixed << "pair_coeff	8 9	lj/sf	2.48E-03	12.032	15.505" << endl;
	output_file1 << fixed << endl;
	output_file1 << fixed << endl;
	...
	output_batch_file << fixed << "#SBATCH --mem-per-cpu=2G -t120:00:00" << endl;
	output_batch_file << fixed << endl;
	output_batch_file << fixed << endl;
	...
	output_batch_file << fixed << "foldername=" + Kn + "_" + Kt + "_" + gamma_n + "_" + gamma_t + "_" + xmu + "_" + "sh_r_" + shear_rate+"_t_"+time+"_titlt2_ec_"+lj_eplison+"_dc_"+ dc_string << endl;
