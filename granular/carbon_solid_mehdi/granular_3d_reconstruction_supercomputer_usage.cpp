...
cout << "diameter of active 1=  " << da1 << endl;
	cout << "diameter of active 2=  " << da2 << endl;
	cout << "diameter of active 3=  " << da3 << endl;
	cout << "diameter of active 4=  " << da4 << endl;
	cout << "diameter of active 5=  " << da5 << endl;
	cout << "diameter of active 6=  " << da6 << endl;
	cout << "diameter of active 7=  " << da7 << endl;
	cout << "diameter of active 8=  " << da8 << endl;
	...
	int run_beginning = 16090000; // usage for the volume fration calculation from pressure_changed lammps output at each timestep
	int run_end = 16100000;



	int report_period = 1000;

	string lammps_output_filename = "dppdata_large_length_vol_change_0.0089_16090000_16100000.txt";
