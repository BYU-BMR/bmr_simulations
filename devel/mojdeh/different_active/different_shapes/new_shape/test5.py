...
class DatafileGenerator():
    ...
    def setUpSimulation(self):
        ...
        self.drawPlane(150,5,120,150)
        #self.drawChickenNugget(70,5,120,40,1,40,"new1.png")
    ...
    def drawPlane(self,x,y,z,dia):
        self.molID += 1
        for xi in np.arange(x-dia/10,x+dia/10,self.dia):
            #for yi in np.arange(y-dia,y+dia,self.dia):
                for zi in np.arange(z-dia/10,z+dia/10,self.dia):
                    self.appendLine(self.active_type,xi,y,zi)
